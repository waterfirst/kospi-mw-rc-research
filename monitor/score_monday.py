...
【고정된 예측 (2026-06-26, 미 세션 라이브 반영)】
  Claude : 방향 UP(반등), 점 8,460, 밴드 8,330–8,640
           근거: -5%↓ 폭락 다음날 82%(9/11) 반등 + 광범위 미지수 녹색.
           단 SOX -4% 반도체 악재로 점추정 하향(8,520→8,460), 방향 UP 유지.
  Codex  : 방향 DOWN(방어), 점 8,340, 밴드 8,250–8,430
  기준 종가(금) : 8,411.21

【미 세션 실측 (6/26 11:49 ET, 세션 2시간차)】
  SOX -4.18% (반도체 특정 매도) / S&P +0.38% / 나스닥 +0.37% / 다우 +0.33%
...
PREV = 8411.21
CLAUDE = {"dir": "UP",   "pt": 8460, "lo": 8330, "hi": 8640}
